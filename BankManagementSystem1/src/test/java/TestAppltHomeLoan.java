...
public void setup() throws ParseException{
	...
	HomeLoan e7 = new HomeLoan(123,7,"2017-06-2",88000,"hella","manager",7,2,userDetails);
...
{//java.util.Date yourDate = sdf.parse("2018-08-12");
HomeLoan e8 = new HomeLoan(125,7, "2018-08-12",88700,"cogni","manager",9,4,userDetails);
	long loanACCNum=applyHomeLoanService.generateLoanAccNumber();
